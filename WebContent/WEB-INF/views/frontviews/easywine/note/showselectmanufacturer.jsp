...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    <head>
		...
		function backfillManufacturer( id , name ){
			pup.dialog.top.noteFunction.backfillManufacturer( id , name );
				...
				<div class="eight columns bottom-3">
					 <table class="style">
					 		<tbody>
					 			...
					 			<c:forEach var="manufacturer" items="${manufacturers}" varStatus="index">
					 				<tr ondblclick="backfillManufacturer( ${manufacturer.id}, '${manufacturer.name}');" style="cursor: pointer;">
					 					<td>${index.index+1}</td>
