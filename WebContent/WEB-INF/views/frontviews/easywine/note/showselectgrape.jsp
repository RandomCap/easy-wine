...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    <head>
		...
		function backfillArea( id , name ){
			pup.dialog.top.noteFunction.backfillGrape( id , name );
				...
				<div class="eight columns bottom-3">
					 <table class="style">
					 		<tbody>
					 			...
					 			<c:forEach var="grape" items="${grapes}" varStatus="index">
					 				<tr ondblclick="backfillArea( ${grape.id}, '${grape.name}');" style="cursor: pointer;">
					 					<td>${index.index+1}</td>
										<td> ${grape.name} </td>
						            </tr>
					 			</c:forEach>
