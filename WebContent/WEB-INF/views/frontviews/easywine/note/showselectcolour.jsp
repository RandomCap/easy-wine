...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    <head>
		...
		function backfillColour( id , name ){
			pup.dialog.top.noteFunction.backfillColour( id , name );
				...
				<div class="eight columns bottom-3">
					 <table class="style">
					 		<tbody>
					 			...
					 			<c:forEach var="colour" items="${colours}" varStatus="index">
					 				<tr ondblclick="backfillColour( ${colour.id}, '${colour.name}');" style="cursor: pointer;">
					 					<td>${index.index+1}</td>
										<td> ${colour.name} </td>
						            </tr>
					 			</c:forEach>
